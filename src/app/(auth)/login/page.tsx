          ...
          <div className="w-4/6 h-full flex felx-col justify-center align-middle py-10 ">
            ...
            >
              <section className="py-4">
                <Link href={"/"}>
                  <button className="rounded-lg p-1 hover:bg-blue-950 duration-300">
                    <CgClose className="text-4xl text-black" />
                  </button>
                </Link>
              </section>

              <h1 className="font-semibold text-3xl my-5 py-5">Iniciar Sesión por el Soporte</h1>
